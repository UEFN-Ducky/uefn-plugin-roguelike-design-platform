#!/usr/bin/env python3
"""Zip + publish roguelike-design-platform to the UEFN Ducky Store via uds_release.
...
Usage:
  ...
  py scripts/release.py --publish --changelog "v1.12.1: Armory power slots"
"""
...
def publish(zip_path: Path, *, category: str, changelog: str) -> None:
    ...
    release_args: dict = {
        ...
        "publish": True,
        "categories": ["plugins"],
        "tags": ["roguelike", "procgen", "level-design"],
    }
    if file_id:
...
def main() -> None:
    ...
    parser.add_argument("--sync-seed", action="store_true", help="Sync into frontend/uefn_plugins/")
